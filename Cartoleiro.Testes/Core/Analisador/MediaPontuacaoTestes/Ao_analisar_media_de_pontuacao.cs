...
namespace Cartoleiro.Testes.Core.Analisador.MediaPontuacaoTestes
{
    [TestClass]
    public class Ao_analisar_media_de_pontuacao : AbstractTesteAutoAct
    {
        Jogador jogador1;
        Jogador jogador2;
        Jogador jogador3;
        ...
        AnalisadorMediaPontuacao analisador;
        ...
        public override void Arrange()
        {
            ...
            analisador = new AnalisadorMediaPontuacao();
        }
